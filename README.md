...
| DB | MySQL 8.0 | 過去の経験を活かし、Spring Bootの復習に集中するため |
| ORM | Spring Data JPA / Hibernate | EntityとRepositoryによるデータアクセスを復習するため |
| Password | Spring Security Crypto / BCrypt | 平文パスワードを保存せず、安全にハッシュ化・照合するため |
...
- [STEP 02 JPAによるデータアクセス](docs/学習ガイド/STEP-02_JPAによるデータアクセス.md)
- [STEP 03 パスワードの安全な保存](docs/学習ガイド/STEP-03_パスワードの安全な保存.md)
